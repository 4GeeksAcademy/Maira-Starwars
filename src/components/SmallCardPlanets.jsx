...
const SmallCardPlanets = ({ name, uid, image }) => {
    ...
    const handleClickHeart = () => {
        ...
        if (!exists) {
            dispatch({ type: 'favorite_element', payload: { name, uid, category: 'planets' } })
        } else {
            dispatch({ type: 'eliminar_favs', payload: {uid, category: 'planets'} })
        }
    };
            ...
            <div className="card-body">
                ...
                <button className="btn btn-outline-warning position-absolute bottom-0 end-0 me-2"
                    onClick={handleClickHeart}>
                        ...
                        (item => item.uid === uid && item.category === 'planets')
...
export default SmallCardPlanets;